...
class SetupScreen(Screen):
    def __init__(self, **kw):
        ...
        root.add_widget(Label(text="Esto se hace una sola vez.",
                              size_hint_y=None, height=22, font_size="13sp"))
        root.add_widget(Label(text="¿Cómo te llamas?", size_hint_y=None, height=24))
        self.in_nombre = TextInput(hint_text="Nombre y apellido", multiline=False,
                                   size_hint_y=None, height=44)
        root.add_widget(self.in_nombre)
        root.add_widget(Label(text="Tus grados y cuántos cursos tiene cada uno:",
                              size_hint_y=None, height=24))
        self.filas_box = BoxLayout(orientation="vertical", size_hint_y=None, spacing=6)
        ...
        self.filas = []
        self._agregar_fila()
        btn_add = Button(text="+ Agregar otro grado", size_hint_y=None, height=44)
    ...
    def _agregar_fila(self):
        fila = BoxLayout(size_hint_y=None, height=44, spacing=6)
        fila.add_widget(Label(text="Grado:", size_hint_x=0.28))
        in_grado = TextInput(hint_text="ej. 11", multiline=False,
                             input_filter="int", size_hint_x=0.3)
        fila.add_widget(in_grado)
        fila.add_widget(Label(text="Cursos:", size_hint_x=0.27))
        sp = Spinner(text="1", values=[str(i) for i in range(1, 11)], size_hint_x=0.15)
        fila.add_widget(sp)
...
class HomeScreen(Screen):
    def __init__(self, **kw):
        super().__init__(**kw)
        self.contenedor = BoxLayout(orientation="vertical", padding=14, spacing=8)
    ...
    def _popup_agregar(self):
        cont = BoxLayout(orientation="vertical", spacing=8, padding=10)
        ...
        fila2 = BoxLayout(size_hint_y=None, height=44, spacing=6)
        ...
        btn = Button(text="Crear", size_hint_y=None, height=46)
        cont.add_widget(btn)
...
class EstudiantesScreen(Screen):
    def __init__(self, **kw):
        super().__init__(**kw)
        self.cont = BoxLayout(orientation="vertical", padding=14, spacing=8)
    ...
    def construir(self):
        ...
        lista_box = BoxLayout(orientation="vertical", size_hint_y=None, spacing=2)
        ...
        b.add_widget(scroll)
        fila = BoxLayout(size_hint_y=None, height=46, spacing=6)
    ...
    def _boton_volver(self, b):
        btn = Button(text="← Volver al menú", size_hint_y=None, height=44)
...
class EsamenesScreen(Screen):
    ...
    def construir(self):
        ...
        if examenes:
            for ruta, nombre, npreg in examenes:
                fila = BoxLayout(size_hint_y=None, height=dp(40), spacing=dp(6))
                fila.add_widget(Label(text=f"{nombre}  ({npreg} preg.)"))
                btn_dl = Factory.BotonPeligro(text="Descargar examen",
                ...
                btn_x = Factory.BotonPeligro(text="X", size_hint_x=None, width=dp(40))
        ...
        scroll.add_widget(lista_box)
        b.add_widget(scroll)
        btn_nuevo = Button(text="+ Crear examen nuevo", size_hint_y=None, height=50)
        btn_nuevo.bind(on_release=lambda *_: self._popup_nuevo())
        b.add_widget(btn_nuevo)
        btn_volver = Button(text="← Volver al menú", size_hint_y=None, height=44)
    ...
    def _popup_nuevo(self):
        cont = BoxLayout(orientation="vertical", spacing=6, padding=10)
        cont.add_widget(Label(text="Nuevo examen", size_hint_y=None, height=28, font_size="16sp"))
        cont.add_widget(Label(text="Nombre:", size_hint_y=None, height=22))
        in_nombre = TextInput(hint_text="ej. Ingles", multiline=False, size_hint_y=None, height=42)
        cont.add_widget(in_nombre)
        cont.add_widget(Label(text="Número de preguntas:", size_hint_y=None, height=22))
        in_num = TextInput(hint_text="ej. 10", multiline=False, input_filter="int",
                           size_hint_y=None, height=42)
        cont.add_widget(in_num)
        cont.add_widget(Label(text="Clave (letras seguidas, ej. ABDC):", size_hint_y=None, height=22))
        in_clave = TextInput(hint_text="ABCD...", multiline=False, size_hint_y=None, height=42)
        cont.add_widget(in_clave)
        fila_chk = BoxLayout(size_hint_y=None, height=36, spacing=6)
        chk = CheckBox(size_hint_x=None, width=36, active=True)
        fila_chk.add_widget(chk)
        fila_chk.add_widget(Label(text="Guardar el PDF de la hoja en Descargas"))
        cont.add_widget(fila_chk)
        lbl_msg = Label(text="", size_hint_y=None, height=24, color=(0.78, 0.16, 0.16, 1))
        cont.add_widget(lbl_msg)
        btn_guardar = Factory.BotonAccion(text="Guardar", size_hint_y=None, height=48)
...
class CalificarScreen(Screen):
    ...
    def construir(self):
        ...
        lista = BoxLayout(orientation="vertical", size_hint_y=None, spacing=2)
        lista.bind(minimum_height=lista.setter("height"))
        if self.resultados:
            lista.add_widget(Label(text="[b]Resultados[/b]", markup=True,
                                   size_hint_y=None, height=26))
            for r in self.resultados:
                fila_r = BoxLayout(size_hint_y=None, height=34, spacing=6)
                codigo = r.get("codigo", "???")
                ...
                btn_e = Button(text="Corregir código", size_hint_x=None, width=140)
    ...
    def _editar_codigo(self, r):
        cont = BoxLayout(orientation="vertical", spacing=8, padding=10)
        cont.add_widget(Label(text=f"Hoja: {r['archivo']}", size_hint_y=None, height=24))
        ...
        cont.add_widget(ti)
        lbl = Label(text="", size_hint_y=None, height=22, color=(0.78, 0.16, 0.16, 1))
        cont.add_widget(lbl)
        btn = Factory.BotonAccion(text="Guardar c\u00f3digo", size_hint_y=None, height=46)
        cont.add_widget(btn)
...
class RegistroScreen(Screen):
    ...
    def construir(self):
        ...
        self.lbl_msg = Label(text=self.mensaje, size_hint_y=None, height=60)
        b.add_widget(self.lbl_msg)

        if self.ultimo_excel:
            btn_abrir = Button(text="Abrir Excel", size_hint_y=None, height=44)
